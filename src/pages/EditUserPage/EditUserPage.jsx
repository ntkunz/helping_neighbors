...
export default function EditUserPage({
  ...
  useEffect(() => {
    ...
    user.barters.forEach((barter) => {
      if (barter.offer === 1) {
        ...
        if (newExchanges !== "")
          newExchanges += purify(", " + barter.skill).trim();
  ...
  async function editUser(e) {
    ...
    await makeApiCall("DELETE", `userskills/${user.user_id}`, null, true);
    await makeApiCall(
      "POST",
      `userskills`,
      { user_id: user.user_id, skills: skillsArray },
      true
    );
  ...
  async function handleDeleteUser(e) {
    ...
    try {
      await makeApiCall("DELETE", "users", deleteUserData, true);
      ...
      <form onSubmit={editUser} method="post" className="edit__form">
        ...
        <div className="edit__personalize">
          ...
          <div className="edit__password">
            ...
            <button
              className="edit__btn delete__btn"
