	...
	if (!neighbors.length) {
		return (
			<div className="neighbors__container--alt">
				...
				<p className="neighbors__paragraph">Tip: Edit your address in the profile tab to be within 1/2 kilometer of 455 Granville St, Vancouver, BC to see some test users</p>
				<p className="neighbors__paragraph">There are many benefits to connecting with neighbors, which you know since you're here. I'd suggest 
				...
				<p className="neighbors__paragraph">This may help get your neighbors involved so that everyone around you can benefit. </p>
				<p className="neighbors__paragraph">If you'd like to see the site in action before you put the work in, you can edit your profile address to 
