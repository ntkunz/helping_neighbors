...
export default function Neighbors({ loggedIn, user, neighbors }) {
  if (!loggedIn) {
    return null;
        ...
        <main className="neighbors--alt">
          ...
          <div className="neighbors__alt-text">
            ...
            <p className="neighbors__tip">
              Tip: Edit your address in the profile tab to be within 1/2
              kilometer of 455 Granville St, Vancouver, BC to see some test
              users
            </p>
            <p className="neighbors__paragraph">
              There are many benefits to connecting with neighbors, which you
              know since you're here. I'd suggest you let people at the local
              cafe or shops know about the site, mention it to neighbors in
              passing, or share the site on local social media groups.
            </p>
            <p className="neighbors__paragraph">
