        ...
        <div className="login">
            ...
            <div className="login-info">
                <div className="login-info__qa">
                    ...
                    {/* <p className="login-info__answer">Helping Neighbors is a platform for neighbors to help each other out. We are a community of neighbors interested in exchanging our strengths with our neighbors' strengths so that we can all do what we love. We believe that a sharing, connected neighborhood is a paradise.</p> */}
