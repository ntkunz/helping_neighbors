...
export default function LoginPage({ setToken }) {
  ...
  async function handleLogin(loginForm) {
    ...
    try {
      const returnedUser = await makeApiCall("POST", `users/login`, loginData);
      if (returnedUser.user.email === emailAtLogin) {
        placeToken(returnedUser.token);
            ...
            <div className="login-form__box">
              ...
              <input
                ...
                onChange={(changeEmail) => {
                  setEmail(changeEmail.target.value);
                }}
                value={email}
              />
              ...
              <input
                ...
                onChange={(changePassword) => {
                  setPassword(changePassword.target.value);
                }}
                value={password}
              />
            </div>
