		...
		<div className="footer">
			...
			{contact && (
				...
				<div className="footer__section">
					...
					<p className="footer__paragraph">
						If you'd like to get ahold of us, please email us at HelpingNeighbors@gmail.com
						{/* If you'd like to get ahold of us, please email us at <a className="mail-link" href="mailto:helpingneighbors@gmail.com">HelpingNeighbors@gmail.com</a> */}
					</p>
				</div>
				</Link>
			)}
