  ...
  function handleContact(e) {
    ...
    return (
      ...
      <div className="footer__section" id="why">
          ...
          <p className="footer__paragraph first-paragraph">There are many reasons why being a helping neighbor feels good, and just as many reasons why 
            having helping neighbors nearby will help you feel safe connected.</p>  
          
          <p className="footer__paragraph">Knowing your neighbors can provide numerous health benefits, such as increased 
          social support, which has been linked to better mental health, and increased physical activity, which can improve 
          cardiovascular health, energy levels, and reduce the risk of chronic health conditions. Additionally, spending 
          time outdoors with your neighbors can provide a mental health boost, as exposure to nature has been linked to 
          reduced stress and improved mood. Moreover, promoting a safer and more secure neighborhood can contribute to better 
          overall health outcomes by reducing stress and anxiety related to safety concerns, and promoting a sense of 
          wellbeing and security within the community. Therefore, building friendly relationships with your neighbors can 
          provide a variety of health benefits that can contribute to a healthier and happier lifestyle.
          </p>
      ...
      {terms &&
            <div className="footer__section" id="why">
            <p className="footer__paragraph first-paragraph">We are excited to provide a platform for our neighbors to connect and exchange 
            services</p>
            <p className="footer__paragraph">This website facilitates the initial introduction. We encourage all users to engage with one another 
            respectfully and to build positive relationships within the community. Please be considerate of others and conduct 
            yourself in a professional and friendly manner when communicating through the website. Remember, the purpose of this 
            platform is to foster a sense of community and togetherness, so let's work together to create a positive and welcoming 
            environment for everyone. Enjoy meeting your neighbors and building a strong and supportive community!
            </p>
        </div>
      }
